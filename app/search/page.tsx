...
import { Search, History, Sparkles, X, LayoutGrid, Film, Tv, ArrowDownUp, Star, User, Globe, Calendar, Compass, Shuffle, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="relative flex flex-col gap-6 pb-28 md:pb-12 pt-[12vh] md:pt-[20vh] min-h-screen">
      ...
      <AnimatePresence mode="wait">
        {searchMode === 'ai' && !query && activePrompts.length > 0 ? (
          <motion.div
            key="ai-suggestions"
              ...
              <div className="flex items-center gap-3">
                <button
                  onClick={() => {
                    ...
                    setDebouncedQuery(randomPrompt);
                  }}
